...
// productManager.addProduct("Producto Prueba", "Este es un producto prueba", 300, "Sin imagen", "abc456", 25).then(products => {
//     console.log(products)})

// productManager.addProduct("Producto Prueba", "Este es un producto prueba", 200, "Sin imagen", "abc456", 25);
 
    // productManager.getProductById(1).then(products => {
//         console.log(products)})
